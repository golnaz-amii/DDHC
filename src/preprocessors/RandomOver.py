...
class RandomOver(BasePreprocessor):
    ...
    def preprocess_data(self):
        ...
        X_train, y_train = ros.fit_resample(X_train, y_train)  # type: ignore
        X_eval, y_eval = ros.fit_resample(X_eval, y_eval)  # type: ignore
        # X_test, y_test = ros.fit_resample(X_test, y_test) # type: ignore
